...
\makeatother
    ...
    \section{Fill In The Gaps}\label{fill-in-the-gaps}
...
[nltk\_data]     /home/scottviteri/nltk\_data{\ldots}
[nltk\_data]   Package wordnet is already up-to-date!
[nltk\_data] Downloading package treebank to
[nltk\_data]     /home/scottviteri/nltk\_data{\ldots}
[nltk\_data]   Package treebank is already up-to-date!
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{}setup}
        ...
        \PY{n}{nltk}\PY{o}{.}\PY{n}{download}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{treebank}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\{'action': 'eat', 'patient': 'tomato', 'tense': 'present', 'agent': 'Mary'\}
    ...
    \subsubsection{One Difference Groupings}\label{one-difference-groupings}
...
\{'action': 'eat', 'patient': 'tomato', 'tense': 'present', 'agent': 'John'\}
\{'action': 'eat', 'patient': 'tomato', 'tense': 'present', 'agent': 'Mary'\}
\{'action': set(['eat']), 'tense': set(['present']), 'patient': set(['tomato',
'potato']), 'agent': set(['John', 'Mary'])\}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{for} \NormalTok{feat }\OperatorTok{in} \NormalTok{event.keys():}
    \ControlFlowTok{if} \NormalTok{new_event[feat] }\OperatorTok{not} \OperatorTok{in} \NormalTok{event[feat]:}
...
'potato']), 'agent': set(['John', 'Mary'])\}]
[\{'action': set(['eat']), 'tense': set(['present']), 'patient': set(['tomato']),
'agent': set(['John', 'Mary'])\}, \{'action': set(['eat']), 'patient': set(['tomato',
'potato']), 'tense': set(['present']), 'agent': set(['John'])\}]
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{checkGoodSentence}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{sentence}\PY{p}{,} \PY{n}{event\PYZus{}groupings}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{sentence} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary eats the potato}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{event\PYZus{}groupings} \PY{o}{=} \PY{n}{train}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{training\PYZus{}sentences}\PY{p}{,} \PY{n}{groupIfOneDiff}\PY{p}{)}
        \PY{n}{event} \PY{o}{=} \PY{n}{s}\PY{o}{.}\PY{n}{sentenceToEventDict}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{sentence}\PY{p}{)}
        \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Event: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{event}\PY{p}{)}
        \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Event Groupings: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{event\PYZus{}groupings}\PY{p}{)}
...
Event Groupings: [\{'action': set(['eat']), 'tense': set(['present']), 'patient':
set(['tomato', 'potato']), 'agent': set(['John', 'Mary'])\}]
True

    \end{Verbatim}

    What the above means is that the grouping structure that we have
generated 'accepts' the sentence 'Mary eats the potato' after being
...
to fill in for 'Mary eats the \_'. So instead of starting with 'Mary
eats the potato', let's start with 'Mary eats the \_', and check the
semantic validity of every word in the lexicon.
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{gapSentenceToFillerWordGuesses}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{event\PYZus{}groupings}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{filler\PYZus{}word\PYZus{}guesses} \PY{o}{=} \PY{n}{gapSentenceToFillerWordGuesses}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary eats the \PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
        \PY{n}{event\PYZus{}groupings}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{k+kn}{from} \PY{n+nn}{nltk.corpus} \PY{k+kn}{import} \PY{n}{wordnet} \PY{k}{as} \PY{n}{wn}
         ...
         \PY{n}{what\PYZus{}mary\PYZus{}eats} \PY{o}{=} \PY{n}{gapSentenceToFillerWordGuesses}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{event\PYZus{}groupings}\PY{p}{)}
         \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{What Mary Eats: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{what\PYZus{}mary\PYZus{}eats}\PY{p}{)}
         \PY{n}{synonyms} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{w}\PY{p}{:} \PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{lemma\PYZus{}names}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{wn}\PY{o}{.}\PY{n}{synsets}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{)}\PY{p}{,}
         \PY{n}{what\PYZus{}mary\PYZus{}eats}\PY{p}{)}\PY{p}{)}
         \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{What Mary Eats Extended: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{synonyms}\PY{p}{)}
         \PY{k}{print}
         
         \PY{n}{sents} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary eats the }\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{syn} \PY{k}{for} \PY{n}{syn} \PY{o+ow}{in} \PY{n}{synonyms}\PY{p}{]}
         \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{sents}\PY{p}{:} \PY{k}{print} \PY{n}{x}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
What Mary Eats: ['potato', 'tomato']
What Mary Eats Extended: [u'potato', u'white\_potato', u'Irish\_potato', u'murphy',
u'spud', u'tater', u'potato', u'white\_potato', u'white\_potato\_vine',
u'Solanum\_tuberosum', u'tomato', u'tomato', u'love\_apple', u'tomato\_plant',
u'Lycopersicon\_esculentum']
...
Mary eats the Lycopersicon\_esculentum
    ...
    What if I try to replace the verb using synonyms? I lose tense
information, and create ungrammatical sentences.
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{gap\PYZus{}sentence} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary \PYZus{} the tomato}\PY{l+s+s1}{\PYZsq{}}
         ...
         \PY{n}{verb\PYZus{}synonyms} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{w}\PY{p}{:} \PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{lemma\PYZus{}names}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{wn}\PY{o}{.}\PY{n}{synsets}\PY{p}{(}\PY{n}{w}\PY{p}{,}
         \PY{n}{wn}\PY{o}{.}\PY{n}{VERB}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{what\PYZus{}mary\PYZus{}did}\PY{p}{)}\PY{p}{)}
         
         \PY{k}{for} \PY{n}{verb} \PY{o+ow}{in} \PY{n}{synonyms}\PY{p}{:}
             \PY{n}{sentence} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary }\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{verb}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ the tomato}\PY{l+s+s1}{\PYZsq{}}
             \PY{k}{print} \PY{n}{sentence}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
Mary potato the tomato
Mary white\_potato the tomato
Mary Irish\_potato the tomato
Mary murphy the tomato
Mary spud the tomato
Mary tater the tomato
Mary potato the tomato
Mary white\_potato the tomato
Mary white\_potato\_vine the tomato
Mary Solanum\_tuberosum the tomato
Mary tomato the tomato
Mary tomato the tomato
Mary love\_apple the tomato
Mary tomato\_plant the tomato
Mary Lycopersicon\_esculentum the tomato
...
Below, we try this with the Penn Tree Bank grammar.
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kn}{from} \PY{n+nn}{nltk.corpus} \PY{k+kn}{import} \PY{n}{treebank}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
[Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP', [Tree('VBP',
['has']), Tree('NP-TMP-CLR', [Tree('NN', ['food'])])])]), Tree('S', [Tree('NP-SBJ-8',
[Tree('NNP', ['Mary'])]), Tree('VP', [Tree('VP', [Tree('VBP', ['has']), Tree('NP-TMP-
CLR', [Tree('NN', ['food'])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP',
['Mary'])]), Tree('VP', [Tree('VP', [Tree('VBZ', ['has']), Tree('NP-PRD', [Tree('NN',
['food'])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP',
[Tree('VP', [Tree('VBZ', ['has']), Tree('NP-PRD', [Tree('NP', [Tree('NN',
['food'])])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP',
[Tree('VP', [Tree('VBZ', ['has']), Tree('NP-PRD', [Tree('NP', [Tree('NP', [Tree('NN',
['food'])])])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]),
Tree('VP', [Tree('VP', [Tree('VBP', ['has']), Tree('NP-PRD', [Tree('NN',
['food'])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP',
[Tree('VP', [Tree('VBP', ['has']), Tree('NP-PRD', [Tree('NP', [Tree('NN',
['food'])])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP',
[Tree('VP', [Tree('VBP', ['has']), Tree('NP-PRD', [Tree('NP', [Tree('NP', [Tree('NN',
['food'])])])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]),
Tree('VP', [Tree('VP', [Tree('VBZ', ['has']), Tree('NP-CLR', [Tree('NN',
['food'])])])])]), Tree('S', [Tree('NP-SBJ-8', [Tree('NNP', ['Mary'])]), Tree('VP',
[Tree('VP', [Tree('VBP', ['has']), Tree('NP-CLR', [Tree('NN', ['food'])])])])])]
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{bash}
         cd ./link\PYZhy{}4.1b\PYZhy{}mod/ \PYZam{}\PYZam{} make \PYZhy{}B
\end{Verbatim}
...
obj/count.o obj/build-disjuncts.o obj/constituents.o obj/print-util.o  -o ./parse
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{def} \PY{n+nf}{filterBySyntax}\PY{p}{(}\PY{n}{sentences}\PY{p}{)}\PY{p}{:}
         ...
         \PY{n}{verb\PYZus{}synonyms} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{w}\PY{p}{:} \PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{lemma\PYZus{}names}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{wn}\PY{o}{.}\PY{n}{synsets}\PY{p}{(}\PY{n}{w}\PY{p}{,}
         \PY{n}{wn}\PY{o}{.}\PY{n}{VERB}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{what\PYZus{}mary\PYZus{}did}\PY{p}{)}\PY{p}{)}
         \PY{n}{input\PYZus{}sentences} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary }\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{verb}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ the tomatoes}\PY{l+s+s1}{\PYZsq{}} \PY{k}{for} \PY{n}{verb} \PY{o+ow}{in} \PY{n}{verb\PYZus{}synonyms}\PY{p}{]}
         \PY{n}{syntactical\PYZus{}sentences} \PY{o}{=} \PY{n}{filterBySyntax}\PY{p}{(}\PY{n}{input\PYZus{}sentences}\PY{p}{)}
         \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Input Sentences: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{input\PYZus{}sentences}\PY{p}{)}
         \PY{k}{print}
         
         \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Grammatical Sentences: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{syntactical\PYZus{}sentences}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
Input Sentences: [u'Mary eat the tomatoes', u'Mary eat the tomatoes', u'Mary feed the
tomatoes', u'Mary eat the tomatoes', u'Mary eat the tomatoes', u'Mary eat\_on the
tomatoes', u'Mary consume the tomatoes', u'Mary eat\_up the tomatoes', u'Mary use\_up
the tomatoes', u'Mary eat the tomatoes', u'Mary deplete the tomatoes', u'Mary exhaust
the tomatoes', u'Mary run\_through the tomatoes', u'Mary wipe\_out the tomatoes', u'Mary
corrode the tomatoes', u'Mary eat the tomatoes', u'Mary rust the tomatoes', u'Mary eat
the tomatoes', u'Mary eat the tomatoes', u'Mary feed the tomatoes', u'Mary eat the
tomatoes', u'Mary eat the tomatoes', u'Mary eat\_on the tomatoes', u'Mary consume the
tomatoes', u'Mary eat\_up the tomatoes', u'Mary use\_up the tomatoes', u'Mary eat the
tomatoes', u'Mary deplete the tomatoes', u'Mary exhaust the tomatoes', u'Mary
run\_through the tomatoes', u'Mary wipe\_out the tomatoes', u'Mary corrode the
tomatoes', u'Mary eat the tomatoes', u'Mary rust the tomatoes']

Grammatical Sentences: []

    \end{Verbatim}

    This did not let a single sentence through the grammar checker, as
expected.

Now let's use the NodeBox English Linguistics library to force
conjugation of the proposed verbs, and then check our work with our
grammar checker.

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{conjs} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{n}{verb} \PY{o+ow}{in} \PY{n}{verb\PYZus{}synonyms}\PY{p}{:}
             \PY{k}{try}\PY{p}{:}
                 \PY{n}{conj} \PY{o}{=} \PY{n}{en}\PY{o}{.}\PY{n}{verb}\PY{o}{.}\PY{n}{present}\PY{p}{(}\PY{n}{verb}\PY{p}{,} \PY{n}{person}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,} \PY{n}{negate}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{)}
                 \PY{n}{conjs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{conj}\PY{p}{)}
             \PY{k}{except} \PY{n+ne}{Exception} \PY{k}{as} \PY{n}{e}\PY{p}{:}
                 \PY{n}{conjs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
         \PY{k}{print} \PY{n}{verb\PYZus{}synonyms}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
         \PY{k}{print} \PY{n}{conjs}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
[u'eat', u'eat', u'feed', u'eat', u'eat', u'eat\_on', u'consume', u'eat\_up', u'use\_up',
u'eat']
['eats', 'eats', 'fees', 'eats', 'eats', '', 'consumes', '', '', 'eats']
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{conj\PYZus{}sents} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary }\PY{l+s+s1}{\PYZsq{}}\PY{o}{+}\PY{n}{conj}\PY{o}{+}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ the tomato}\PY{l+s+s1}{\PYZsq{}} \PY{k}{for} \PY{n}{conj} \PY{o+ow}{in} \PY{n}{conjs} \PY{k}{if} \PY{n}{conj}\PY{p}{]}
...
to automate the conjugation/modification of our generated sentences.
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}start\PYZus{}sentence = \PYZsq{}Mary \PYZus{} the tomato\PYZsq{}}
         ...
         \PY{n}{generated\PYZus{}event\PYZus{}structures} \PY{o}{=} \PY{p}{[}\PY{n}{s}\PY{o}{.}\PY{n}{sentenceToEventDict}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{sentence}\PY{p}{)} \PY{k}{for} \PY{n}{sentence} \PY{o+ow}{in}
         \PY{n}{what\PYZus{}mary\PYZus{}did\PYZus{}sentences}\PY{p}{]}
...
\{'action': 'eat', 'patient': 'tomato', 'tense': 'present', 'agent': 'Mary'\}
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{s}\PY{o}{.}\PY{n}{parse\PYZus{}input\PYZus{}str}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{what\PYZus{}mary\PYZus{}did\PYZus{}sentences}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\texttt{\color{outcolor}Out[{\color{outcolor}18}]:}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{FillInTheGaps_files/FillInTheGaps_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{tree} \PY{o}{=} \PY{n}{s}\PY{o}{.}\PY{n}{parse\PYZus{}input\PYZus{}str}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{what\PYZus{}mary\PYZus{}did\PYZus{}sentences}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
...
(Start[]
  (S[]
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{subtree} \PY{o}{=} \PY{n}{tree}\PY{o}{.}\PY{n}{pos}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{c+c1}{\PYZsh{} 2nd element of sentence was blank}
...
[ tense  = True ]
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{test\PYZus{}sentence} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mary \PYZus{} the tomato}\PY{l+s+s1}{\PYZsq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
[u'potato', u'white\_potato', u'Irish\_potato', u'murphy', u'spud', u'tater', u'potato',
u'white\_potato', u'white\_potato\_vine', u'Solanum\_tuberosum', u'tomato', u'tomato',
u'love\_apple', u'tomato\_plant', u'Lycopersicon\_esculentum']
...
of our synonyms!
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{}precompute}
         ...
         \PY{n}{word\PYZus{}guesses} \PY{o}{=} \PY{n+nb}{map}\PY{p}{(}\PY{k}{lambda} \PY{n}{gap\PYZus{}sentence}\PY{p}{:} \PY{n}{gapSentenceToFillerWordGuesses}\PY{p}{(}\PY{n}{sem}\PY{p}{,}
         \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{event\PYZus{}groupings}\PY{p}{)}\PY{p}{,} \PY{n}{gap\PYZus{}sentences}\PY{p}{)}
         \PY{n}{sents\PYZus{}and\PYZus{}guesses} \PY{o}{=} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{gap\PYZus{}sentences}\PY{p}{,}\PY{n}{word\PYZus{}guesses}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}23}]:} \PY{k}{def} \PY{n+nf}{findPOS}\PY{p}{(}\PY{n}{features}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{feat\PYZus{}type\PYZus{}index} \PY{o}{=} \PY{n+nb}{filter}\PY{p}{(}\PY{k}{lambda} \PY{p}{(}\PY{n}{i}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{:} \PY{n+nb}{type}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o+ow}{is} \PY{n}{nltk}\PY{o}{.}\PY{n}{featstruct}\PY{o}{.}\PY{n}{Feature}\PY{p}{,}
         \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{feat\PYZus{}keys}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         ...
         \PY{k}{def} \PY{n+nf}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}words}\PY{p}{,} \PY{n}{generalizationProcedure}\PY{p}{,}
         \PY{n}{filtering}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{if} \PY{n}{filtering}\PY{p}{:}
                 \PY{k}{return} \PY{n}{filterBySyntax}\PY{p}{(}\PY{n}{conjugated\PYZus{}gens}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{k}{return} \PY{n}{conjugated\PYZus{}gens}
         
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
['eats', 'eats', 'fees', 'eats', 'eats', 'consumes', 'eats', 'depletes', 'exhausts',
'corrodes', 'eats', 'rusts', 'eats', 'eats', 'fees', 'eats', 'eats', 'consumes',
'eats', 'depletes', 'exhausts', 'corrodes', 'eats', 'rusts']
[u'potato', u'white\_potato', u'Irish\_potato', u'murphy', u'spud', u'tater', u'potato',
u'white\_potato', u'white\_potato\_vine', u'Solanum\_tuberosum', u'tomato', u'tomato',
u'love\_apple', u'tomato\_plant', u'Lycopersicon\_esculentum']
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{k}{def} \PY{n+nf}{getSharedHypernyms}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}only use on Nouns}
             ...
             \PY{k}{return} \PY{n+nb}{reduce}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{lowest\PYZus{}common\PYZus{}hypernyms}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}
         \PY{n}{pairwise\PYZus{}synsets}\PY{p}{)}\PY{o}{.}\PY{n}{lemma\PYZus{}names}\PY{p}{(}\PY{p}{)}
         
         \PY{k}{def} \PY{n+nf}{getEntailments}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}only use on Verbs}
             \PY{n}{synsets} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{p}{[}\PY{n}{wn}\PY{o}{.}\PY{n}{synsets}\PY{p}{(}\PY{n}{filler\PYZus{}word}\PY{p}{,} \PY{n}{wn}\PY{o}{.}\PY{n}{VERB}\PY{p}{)} \PY{k}{for} \PY{n}{filler\PYZus{}word} \PY{o+ow}{in}
         \PY{n}{filler\PYZus{}words}\PY{p}{]}\PY{p}{)}
             ...
             \PY{k}{return} \PY{n}{flatten}\PY{p}{(}\PY{p}{[}\PY{n}{x}\PY{o}{.}\PY{n}{lemma\PYZus{}names}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{ents}\PY{p}{]}\PY{p}{)}
         ...
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,}
         \PY{n}{getSharedHypernymsOrEntailments}\PY{p}{)}
             \PY{k}{print} \PY{n}{gens}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}26}]:} \PY{k}{def} \PY{n+nf}{getHyponymClosure}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}Noun}
             ...
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                 \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{n+nb}{len}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                     \PY{n}{a}\PY{p}{,}\PY{n}{b} \PY{o}{=} \PY{n}{filler\PYZus{}words}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{filler\PYZus{}words}\PY{p}{[}\PY{n}{j}\PY{p}{]}
                     \PY{n}{pairwise\PYZus{}synsets}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{findLowest}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
             \PY{n}{hypernym\PYZus{}synset} \PY{o}{=} \PY{n+nb}{reduce}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{:} \PY{n}{x}\PY{o}{.}\PY{n}{lowest\PYZus{}common\PYZus{}hypernyms}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}
         \PY{n}{pairwise\PYZus{}synsets}\PY{p}{)}
         ...
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,}
         \PY{n}{getHyponymsClosureOrEntailments}\PY{p}{)}
             \PY{k}{print} \PY{n}{gens}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{10}\PY{p}{]}
\end{Verbatim}
...
on the type of word.
   ...
   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}27}]:} \PY{n}{training\PYZus{}sentences\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Input/training.txt}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{gap\PYZus{}sentences\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Input/testing.txt}\PY{l+s+s1}{\PYZsq{}}
         ...
         \PY{k}{def} \PY{n+nf}{fillInTheGaps}\PY{p}{(}\PY{n}{training\PYZus{}sentences}\PY{p}{,} \PY{n}{gap\PYZus{}sentences}\PY{p}{,} \PY{n}{groupingProcedure}\PY{p}{,}
         \PY{n}{generalizationProcedure}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{with}
         \PY{n+nb}{open}\PY{p}{(}\PY{n}{output\PYZus{}dir}\PY{o}{+}\PY{n}{groupingProcedure}\PY{o}{.}\PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}}\PY{o}{+}\PY{n}{generalizationProcedure}\PY{o}{.}\PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}}\PY{o}{+}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.txt}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
         \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w+}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                 \PY{k}{for} \PY{n}{gap\PYZus{}sentence} \PY{o+ow}{in} \PY{n}{gap\PYZus{}sentences}\PY{p}{:}
                     \PY{n}{filler\PYZus{}word\PYZus{}guesses} \PY{o}{=} \PY{n}{gapSentenceToFillerWordGuesses}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,}
         \PY{n}{event\PYZus{}groupings}\PY{p}{)}
                     \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,}
         \PY{n}{generalizationProcedure}\PY{p}{)}
                     \PY{k}{for} \PY{n}{g} \PY{o+ow}{in} \PY{n}{gens}\PY{p}{:}
         ...
         \PY{n}{fillInTheGaps}\PY{p}{(}\PY{n}{training\PYZus{}sentences}\PY{p}{,} \PY{n}{gap\PYZus{}sentences}\PY{p}{,} \PY{n}{groupIfOneDiff}\PY{p}{,}
         \PY{n}{getHyponymsClosureOrEntailments}\PY{p}{)}
         \PY{n}{fillInTheGaps}\PY{p}{(}\PY{n}{training\PYZus{}sentences}\PY{p}{,} \PY{n}{gap\PYZus{}sentences}\PY{p}{,} \PY{n}{groupIfOneOrTwoDiffs}\PY{p}{,}
         \PY{n}{getHyponymsClosureOrEntailments}\PY{p}{)}
\end{Verbatim}

   \begin{Verbatim}[commandchars=\\\{\},fontsize=\scriptsize]
{\color{incolor}In [{\color{incolor}28}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{bash}
         head \PYZhy{}10 ./Output/groupIfOneDiffgetSynonyms.txt
         tail \PYZhy{}10 ./Output/groupIfOneDiffgetSynonyms.txt
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}29}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{bash}
         head \PYZhy{}10 ./Output/groupIfOneDiffgetHyponymsClosureOrEntailments.txt
         tail \PYZhy{}10 ./Output/groupIfOneDiffgetHyponymsClosureOrEntailments.txt
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
Mary eats the aquatic\_plant
Mary eats the water\_plant
Mary eats the hydrophyte
Mary eats the hydrophytic\_plant
Mary eats the bulbous\_plant
Mary eats the cormous\_plant
Mary eats the creeper
Mary eats the cultivar
Mary eats the cultivated\_plant
Mary eats the deciduous\_plant
