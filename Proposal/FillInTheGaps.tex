...
of our synonyms!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{k}{def} \PY{n+nf}{findPOS}\PY{p}{(}\PY{n}{features}\PY{p}{)}\PY{p}{:}
         ...
         \PY{k}{def} \PY{n+nf}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}words}\PY{p}{,} \PY{n}{generalizationProcedure}\PY{p}{,} \PY{n}{filtering}\PY{o}{=}\PY{n+nb+bp}{False}\PY{p}{)}\PY{p}{:} 
         ...
         \PY{c+c1}{\PYZsh{}gap\PYZus{}sentences = [\PYZsq{}Mary \PYZus{} the tomato\PYZsq{}, \PYZsq{}Mary eats the \PYZus{}\PYZsq{}]\PYZsh{}, \PYZsq{}\PYZus{} eats the tomato\PYZsq{}]}
         \PY{c+c1}{\PYZsh{}word\PYZus{}guesses = map(lambda gap\PYZus{}sentence: gapSentenceToFillerWordGuesses(sem, gap\PYZus{}sentence, event\PYZus{}groupings), gap\PYZus{}sentences)}
         \PY{c+c1}{\PYZsh{}sents\PYZus{}and\PYZus{}guesses = zip(gap\PYZus{}sentences,word\PYZus{}guesses)}
         ...
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,} \PY{n}{getSynonyms}\PY{p}{,} \PY{n+nb+bp}{False}\PY{p}{)}
...
[u'potato', u'white\_potato', u'Irish\_potato', u'murphy', u'spud', u'tater', u'potato', u'white\_potato', u'white\_potato\_vine', u'Solanum\_tuberosum', u'tomato', u'tomato', u'love\_apple', u'tomato\_plant', u'Lycopersicon\_esculentum']

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{n}{filled\PYZus{}sentences} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,} \PY{n}{getSynonyms}\PY{p}{,} \PY{n+nb+bp}{False}\PY{p}{)}
...
Following this idea, we introduce generalization by shared hypernymy.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{k}{def} \PY{n+nf}{getSharedHypernyms}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}only use on Nouns}
         ...
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,} \PY{n}{getSharedHypernymsOrEntailments}\PY{p}{)}
             \PY{k}{print} \PY{n}{gens}
\end{Verbatim}
...
previous generalizations in this paper.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{k}{def} \PY{n+nf}{getHyponymClosure}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}Noun}
             \PY{n}{pairwise\PYZus{}synsets} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                 \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{n+nb}{len}\PY{p}{(}\PY{n}{filler\PYZus{}words}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                     \PY{n}{a}\PY{p}{,}\PY{n}{b} \PY{o}{=} \PY{n}{filler\PYZus{}words}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{filler\PYZus{}words}\PY{p}{[}\PY{n}{j}\PY{p}{]}
         ...
         \PY{k}{for} \PY{p}{(}\PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{)} \PY{o+ow}{in} \PY{n}{sents\PYZus{}and\PYZus{}guesses}\PY{p}{:}
             \PY{n}{gens} \PY{o}{=} \PY{n}{generalizeAndConjugate}\PY{p}{(}\PY{n}{sem}\PY{p}{,} \PY{n}{gap\PYZus{}sentence}\PY{p}{,} \PY{n}{filler\PYZus{}word\PYZus{}guesses}\PY{p}{,} \PY{n}{getHyponymsClosureOrEntailments}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
['chews', 'masticates', 'manducates', 'jaws', 'swallows', 'chews', 'masticates', 'manducates', 'jaws', 'swallows']
[u'aquatic\_plant', u'water\_plant', u'hydrophyte', u'hydrophytic\_plant', u'bulbous\_plant', u'cormous\_plant', u'creeper', u'cultivar', u'cultivated\_plant', u'deciduous\_plant']
...
on the type of word.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{n}{training\PYZus{}sentences\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Input/training.txt}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{gap\PYZus{}sentences\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Input/testing.txt}\PY{l+s+s1}{\PYZsq{}}
...
Future Work: 1. Grouping procedures that use synsets during the
iterative grouping. 2. Grouping procedures that only group according to
n/log(n) human learning rule 3. Extending supported parts of speech
